...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -0.3998036454  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(3, 6)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -1.7761207685  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_from():
    ...
    # Test 4:
    expected = 3
    answer = count_sines_from(11, 15)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 5
    answer = count_sines_from(8, 15)
...
def count_sines_vs_cosines(m):
    ...
    count = 0  # Initialize to 0 BEFORE the loop
    x = -m
    for k in range((m * 2) + 1):  # Loop
        if math.sin(x) > math.cos(x):  # If the condition holds:
            count = count + 1  # Increment INSIDE the loop.
        x = x + 1
